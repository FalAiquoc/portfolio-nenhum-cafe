...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#FAF6F0] text-[#3E2723] antialiased selection:bg-amber-100 selection:text-[#3E2723]">
      ...
      {/* HEADER */}
      <header className={`fixed top-0 sm:top-18 left-0 right-0 z-40 transition-all duration-300 ${scrolled ? 'bg-[#FAF6F0] shadow-lg py-2 border-b border-amber-900/10' : 'bg-transparent py-4'}`}>
